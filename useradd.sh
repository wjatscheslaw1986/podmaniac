...
groupadd -g 100200 -r -o pod_mysql && useradd -g pod_mysql -r -o -M -e 1970-01-01 -u 100200 -s /sbin/nologin pod_mysql
groupadd -g 100400 -r -o pod_postgres && useradd -g pod_postgres -r -o -M -e 1970-01-01 -u 100400 -s /sbin/nologin pod_postgres
